const NavBar = () => {
  return (
    <>
      <nav className="w-full h-[77px] bg-[#6B3CC9]">
        <div className="flex  h-full text-[#FFF] text-[14px] font-inter font-medium items-center xlg:mx-[80px] xl:mx-[60px] md:mx-[40px] mx-[20px]">
          <div className="">
            <svg
          ...
          <div className="flex-none hidden md:block">SERVICES</div>
          <div className="flex-none md:block hidden ml-[28px]">ABOUT US</div>
          <div className="flex-none md:block hidden ml-[28px]">CONTACT US</div>
          <div className="flex-none md:block hidden ml-[28px]">CAREERS</div>
          <svg
